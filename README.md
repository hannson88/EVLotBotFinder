...
- Set AC or DC charger availability alerts
...
- Automatically removes an alert after it is delivered
...
| `/subs` | View and manage your active alerts |
...
4. When a charger transitions from unavailable to available, all matching alert users are notified in batches (up to 30 messages at a time) and their alerts are removed.
